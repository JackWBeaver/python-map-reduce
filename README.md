...
The command used to process the larger file in Case 2: 'cat purchases.txt | python 21mapper.py | sort | python 22reducer.py'
...
- [https://github.com/JackWBeaver/python-map-reduce](https://github.com/JackWBeaver/python-map-reduce)
